...
export const GuiaLeadForm = () => {
  ...
  return (
    <form onSubmit={handleSubmit} className="space-y-4 rounded-xl bg-white p-6 shadow-lg">
      <h3 className="mb-2 text-xl font-bold text-[#1E3A8A]">
        Baixe GRÁTIS o Guia dos Temas + Apostas 2025
      </h3>

      <div className="space-y-2">
        <Label htmlFor="guia-name" className="text-[#1E3A8A]">
          Nome completo
        </Label>
        <Input
          id="guia-name"
      ...
      <div className="space-y-2">
        <Label htmlFor="guia-email" className="text-[#1E3A8A]">
          E-mail
        </Label>
        <Input
          id="guia-email"
      ...
      <div className="space-y-2">
        <Label htmlFor="guia-whatsapp" className="text-[#1E3A8A]">
          WhatsApp
        </Label>
        <Input
          id="guia-whatsapp"
      ...
      <Button
        type="submit"
        className="w-full bg-gradient-to-r from-[#FBBF24] to-[#F59E0B] py-6 text-lg font-semibold text-white hover:from-[#F59E0B] hover:to-[#FBBF24]"
