        ...
        <div className="mx-auto max-w-2xl">
          <Card className="card-service">
            <CardHeader className="text-center">
              <CardTitle className="text-2xl lg:text-3xl">Solicite seu Atendimento</CardTitle>
              <CardDescription className="text-lg">
                Preencha o formulário e entraremos em contato via WhatsApp para agendar sua aula ou
                correção.
              </CardDescription>
            </CardHeader>
            ...
            <CardContent>
              <form onSubmit={handleSubmit} className="space-y-6">
                ...
                <div className="space-y-2">
                  <Label htmlFor="whatsapp" className="text-[#1E3A8A]">
                    WhatsApp
                  </Label>
                  <Input
                    id="whatsapp"
              ...
              <div className="mt-6 border-t pt-6 text-center">
                <p className="mb-4 text-sm text-[#1E3A8A]">Ou entre em contato diretamente:</p>
                <Button
                  onClick={() => {
