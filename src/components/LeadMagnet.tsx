            ...
            <Card className="rounded-xl border border-border/50 bg-card shadow-lg">
              <CardContent className="p-8 text-center">
                ...
                <p className="mb-6 text-[#1E3A8A]">
                  Verifique sua caixa de entrada e spam. Em instantes você receberá o PDF com os 10
                  erros mais comuns em redações do ENEM.
                </p>
                <Button
                  onClick={() => {
        ...
        <div className="mx-auto max-w-2xl">
          <Card className="rounded-xl border border-border/50 bg-card shadow-lg">
            <CardHeader className="pb-6 text-center">
              ...
              <p className="text-[#1E3A8A]">Receba agora o PDF + mini-diagnóstico gratuito</p>
            </CardHeader>
