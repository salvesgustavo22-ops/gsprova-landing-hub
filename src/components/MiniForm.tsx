...
export const MiniForm = ({ source = 'hero_miniform' }: MiniFormProps) => {
  ...
  const handleWhatsAppClick = () => {
    ...
    const message = encodeURIComponent(
      'Oi! Acabei de preencher o formulário no site. Quero contratar aula ou correção de redação.'
    );
      ...
      <Card className="rounded-xl border border-border/50 bg-card shadow-lg">
        <CardContent className="p-6 text-center">
          <div className="mb-4">
            ...
            <p className="text-sm text-[#1E3A8A]">Enquanto isso, conheça nossos planos.</p>
          </div>
    ...
    <div ref={formRef}>
      <Card className="rounded-xl border border-border/50 bg-card shadow-lg">
        <CardHeader className="pb-4">
          ...
          <p className="text-sm text-[#1E3A8A]">Preencha e falamos com você em minutos.</p>
        </CardHeader>
        ...
        <CardContent className="pt-0">
          <form onSubmit={handleSubmit} className="space-y-4">
            ...
            <div className="flex items-start space-x-2">
              ...
              />
              <Label htmlFor="lgpd" className="text-xs leading-relaxed text-[#1E3A8A]">
                Autorizo contato do GS Aprova. *
              </Label>
            </div>

            <p className="text-xs text-[#1E3A8A]">Seus dados não serão compartilhados.</p>
