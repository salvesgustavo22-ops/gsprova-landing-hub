...
export type Database = {
  ...
  public: {
    Tables: {
      ...
      guia_leads: {
        Row: {
          ...
          email: string
          id: string
          interest_aulas_particulares: boolean | null
          interest_concursos: boolean | null
          interest_vestibular: boolean | null
          name: string
    ...
    Functions: {
      create_corretor_user: { Args: never; Returns: string }
      ...
      is_corretor_user: { Args: never; Returns: boolean }
    }
    Enums: {
