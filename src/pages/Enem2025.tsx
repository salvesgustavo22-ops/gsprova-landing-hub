...
export default function Enem2025() {
  useEffect(() => {
    ...
    if (metaDescription) {
      metaDescription.setAttribute("content", "Prepare-se para o ENEM 2025 com dicas de matemática, estrutura de redação e estratégias aprovadas. Baixe nosso checklist gratuito com os tópicos que mais caem.");
    }
  ...
  const mathTopics = [
    { title: "Funções", weight: "Alto", description: "Função afim, quadrática, exponencial e logarítmica" },
