  ...
  return (
    <div className="min-h-screen bg-background">
      ...
      <main className="pt-20">
        ...
        {/* Garantia */}
        <section className="bg-[#F3F4F6] py-12 dark:bg-[#0F172A]">
          <div className="container mx-auto px-4 text-center">
            <div className="mb-4 flex items-center justify-center space-x-3 text-[#1E3A8A] dark:text-white">
              <Shield className="size-8" />
              <h2 className="text-2xl font-bold">Garantia Total de 7 Dias</h2>
            </div>
            <p className="mx-auto max-w-2xl text-gray-600 dark:text-white/70">
              Experimente nossos serviços sem risco. Se não ficar satisfeito, devolvemos 100% do seu
              investimento.
            </p>
          </div>
        </section>
